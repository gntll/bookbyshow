        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-2 pt-1.5">
            <button
              ...
              className="px-4 py-2 rounded-lg bg-[#e51821] hover:bg-[#c9121a] text-white font-bold text-sm shadow-md shadow-red-950/40 transition-colors"
            >
              Accept All
            </button>
            <button
              onClick={() => handleAccept('essential')}
              className="px-4 py-2 rounded-lg bg-neutral-900 border border-neutral-800 hover:border-neutral-700 text-neutral-200 hover:text-white font-semibold text-sm transition-colors"
            >
              Essential Only
            </button>
            <Link
              href="/privacy#do-not-sell"
              className="text-xs text-neutral-400 hover:text-white underline ml-auto hidden sm:inline"
            >
