...
export function AggregatorTrustBanner() {
  return (
    <section className="my-16 rounded-xl bg-neutral-900/50 border border-neutral-800 p-6 sm:p-8">
      <div className="max-w-5xl mx-auto">
        {/* Section Header */}
        <div className="text-center max-w-2xl mx-auto mb-10">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md bg-neutral-900 border border-neutral-700 text-neutral-300 text-xs font-semibold uppercase tracking-wider mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="p-6 rounded-xl bg-neutral-900 border border-neutral-700 flex flex-col justify-between relative">
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="px-2 py-0.5 rounded text-[11px] bg-white text-black font-semibold">
                  Save $4.76 (18%)
                </span>
              </div>
            ...
            <div className="mt-6 pt-4 border-t border-neutral-800 flex items-center justify-between">
              <span className="text-xs font-medium text-neutral-400">Total Charged:</span>
              <span className="text-xl font-bold text-white">$21.99</span>
            </div>
          </div>
        </div>
