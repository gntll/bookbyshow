      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-[#0e1015]/95 border border-neutral-800 shadow-2xl backdrop-blur-md">
        ...
        <div className="flex items-center gap-2 mb-4 overflow-x-auto pb-1 scrollbar-none">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all shrink-0 flex items-center gap-1.5 ${
              activeTab === 'movies'
                ? 'bg-[#e51821] text-white shadow-md shadow-red-950/50'
                : 'bg-neutral-900 text-neutral-300 hover:text-white border border-neutral-800'
            }`}
        ...
        <form onSubmit={handleSearchSubmit} className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
          ...
          <div className="md:col-span-5 relative">
            ...
            <input
              ...
              className="w-full bg-neutral-950 border border-neutral-800 rounded-xl pl-10 pr-4 py-2.5 text-sm sm:text-base text-white placeholder-neutral-500 focus:outline-none focus:border-[#e51821] transition-colors"
            />
          </div>
          ...
          <div className="md:col-span-4">
            <button
              ...
              className="w-full bg-neutral-950 border border-neutral-800 hover:border-[#e51821]/50 rounded-xl px-4 py-2.5 text-sm text-left flex items-center justify-between text-neutral-200 hover:text-white transition-colors"
            >
              ...
              <span className="text-xs text-neutral-400 uppercase font-semibold">Change</span>
            </button>
          </div>
          ...
          <div className="md:col-span-3">
            <button
              type="submit"
              className="w-full py-2.5 px-5 rounded-xl bg-[#e51821] hover:bg-[#c9121a] text-white font-bold text-sm flex items-center justify-center gap-1.5 shadow-md shadow-red-950/40 transition-colors"
            >
        ...
        {/* Popular quick tags */}
        <div className="mt-3 pt-3 border-t border-neutral-800/80 flex items-center gap-2 overflow-x-auto text-xs sm:text-sm text-neutral-400 scrollbar-none">
          <span className="shrink-0 text-neutral-400 text-xs font-semibold">Trending Searches:</span>
