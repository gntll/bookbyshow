      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="p-8 rounded-2xl bg-[#0e1015] border border-neutral-800 space-y-6 mb-14">
          ...
          <div className="space-y-4 text-sm text-neutral-300 leading-relaxed">
            ...
            <ul className="space-y-2 text-xs text-neutral-300 ml-4 list-disc">
        ...
        <div className="p-8 rounded-2xl bg-neutral-900/40 border border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link
              href="/contact"
              className="px-5 py-2.5 rounded-lg bg-[#e51821] hover:bg-[#c9121a] text-white font-bold text-xs flex items-center gap-2 shadow-md shadow-red-950/40 transition-colors"
            >
