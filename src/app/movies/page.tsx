      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="p-4 sm:p-5 rounded-2xl bg-[#0e1015] border border-neutral-800 space-y-4 shadow-xl">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
            ...
            <div className="md:col-span-3">
              <select
                ...
                className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-3 py-2.5 text-sm sm:text-base text-white focus:outline-none focus:border-[#e51821]"
              >
          ...
          <div className="flex items-center gap-2 overflow-x-auto pt-2 border-t border-neutral-800/80 scrollbar-none">
            <span className="text-sm text-neutral-400 font-semibold px-2 shrink-0">Genre:</span>
            {allGenres.map((g) => (
              <button
                key={g}
          ...
          <div className="flex items-center gap-2 overflow-x-auto pt-2 border-t border-neutral-800/80 scrollbar-none">
            <span className="text-sm text-neutral-400 font-semibold px-2 shrink-0">Status:</span>
            {[
        ...
        <div className="mt-8">
          ...
          {filtered.length === 0 ? (
            <div className="py-20 text-center rounded-2xl bg-[#0e1015] border border-neutral-800">
              <p className="text-white font-bold text-lg">No movies match your filters</p>
              <p className="text-sm text-neutral-400 mt-1">Try resetting the search query or selecting &lsquo;All&rsquo; formats.</p>
              <button
                onClick={() => {
                  setSearchQuery('');
                ...
                className="mt-4 px-4 py-2 rounded-lg bg-[#e51821] hover:bg-[#c9121a] text-white text-sm font-bold shadow-md shadow-red-950/40 transition-colors"
              >
                Reset All Filters
              </button>
            </div>
