        ...
        {watchlist.length === 0 ? (
          <div className="py-20 text-center rounded-2xl bg-[#0e1015] border border-neutral-800 max-w-md mx-auto p-8 space-y-4 shadow-xl">
            ...
            <div className="pt-2 flex items-center justify-center gap-3">
              <Link
                href="/movies"
                className="px-5 py-2.5 rounded-lg bg-[#e51821] hover:bg-[#c9121a] text-white font-bold text-sm shadow-md shadow-red-950/40 transition-colors"
              >
                Explore Movies
              </Link>
              <Link
                href="/events"
                className="px-5 py-2.5 rounded-lg bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 text-white font-semibold text-sm transition-colors"
              >
                Explore Events
              </Link>
            </div>
            ...
            {watchlist.map((item) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between h-24 py-1">
                  <div>
                    <div className="flex items-center gap-1.5 text-xs text-neutral-400 uppercase font-semibold">
                      {item.type === 'movie' ? (
                        <>
                    ...
                    <h4 className="font-bold text-white text-base truncate mt-0.5 group-hover:text-red-400 transition-colors">
                      {item.title}
                    </h4>
                    <span className="text-sm text-white font-black block mt-1">
                  ...
                  <div className="flex items-center justify-between gap-2 pt-1 border-t border-neutral-800">
                    <Link
                      ...
                      className="text-sm font-bold text-[#e51821] hover:underline flex items-center gap-1"
                    >
                      <span>Showtimes</span>
